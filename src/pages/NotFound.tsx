      ...
      <div className="flex flex-1 items-center justify-center px-4 py-16">
        <div className="rise-in w-full max-w-lg text-center">
          <div className="flex justify-center">
            <span className="relative flex size-16 items-center justify-center rounded-2xl border border-gold/35 bg-void shadow-[0_0_30px_-8px_var(--crimson-glow)]">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link to="/dashboard" className="btn-gold px-5 py-2.5 text-sm">
